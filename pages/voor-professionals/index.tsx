      ...
      <article>
        ...
        <section>
          ...
          <p>
            ...
            Om dit mogelijk te maken vragen we werkgevers om deze uren vrij te
            maken voor enthousiaste medewerkers. Gelukkig hebben veel bedrijven
            al regelingen om een maatschappelijke bijdrage te leveren namens het
            bedrijf voor 40 (of meer) uur. En uiteraard verwelkomt Co-Teach ook
            zzp'ers. Let op dat het hele traject, inclusief voorbereiding en
            afronding, waarschijnlijk ook wat van je eigen tijd in beslag zal
            nemen.
          </p>
          ...
          <p>
            ...
            expertise en eventuele projectideeën nader toe te lichten. Dit helpt
            ons om een groep leerlingen te vinden die voorbereid is om in jouw
            wereld te duiken. Ook vragen we je alvast wat voor tijdsinzet
            mogelijk is voor je: verspreid over meerdere weken of juist
            instensief (bijv. een projectweek).
          </p>
          <p>
            Nadat je je aangemeld hebt wordt je opgenomen in de Co-Teach
            gastdocent-database. Geen zorgen, deze is AVG-proof en wordt beheerd
            door de Universiteit van Utrecht (lees{" "}
          ...
          <p>
            Wanneer we een goede match voor je gevonden hebben sturen we je een
            uitnodiging om daadwerkelijk een co-teach traject af te leggen.
            Nadat jij en je werkgever (waar van toepassing) akkoord zijn gegaan
            met de voorwaarden, begint het voortraject.
          </p>
          <p>
          ...
          <h3>Co-Teaching</h3>
          <p>
            Met je project op zak ga je aan de slag op jouw school. Hier werk je
            samen met een co-teacher: een (anders-)bevoegde docent die je
